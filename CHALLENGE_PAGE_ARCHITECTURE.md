...
**Continue** links to **`/curiosity/[slug]#whats-next`**, where the lesson page exposes a **`#whats-next`** section (next-step CTA + short copy about follow-ups/trails coming later).
