...
const CATEGORY_THEMES: Record<string, CategoryTheme> = {
  science: {
    ...
    bar: "bg-sky-700 dark:bg-sky-600",
    icon: FlaskConical,
  },
  history: {
  ...
  technology: {
    ...
    bar: "bg-cyan-700 dark:bg-cyan-600",
    icon: Cpu,
  },
  culture: {
    ...
    bar: "bg-violet-700 dark:bg-violet-600",
    icon: Palette,
  },
  psychology: {
    ...
    bar: "bg-rose-700 dark:bg-rose-600",
    icon: Brain,
  },
  space: {
    ...
    bar: "bg-indigo-700 dark:bg-indigo-600",
    icon: Rocket,
  },
  biology: {
...
const DEFAULT_THEME: CategoryTheme = {
  ...
  bar: "bg-slate-700 dark:bg-slate-600",
  icon: Sparkles,
};
