...
**Local checks**: `npm run ai:topic-ideas` (4.2), `npm run ai:lesson` (4.3), and `npm run ai:challenge` (4.4) load `.env.local` and call OpenAI—run only on your machine, not in client bundles.
